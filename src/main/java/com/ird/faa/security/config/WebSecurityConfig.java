...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/contributeur/login").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/client/").hasAnyAuthority(AuthoritiesConstants.CLIENT);
            http.authorizeRequests().antMatchers("/api/contributeur/").hasAnyAuthority(AuthoritiesConstants.CONTRIBUTEUR);
