...
@Service
public class SignatureContributeurServiceImpl extends AbstractServiceImpl<Signature> implements SignatureContributeurService {

@Autowired
private SignatureDao signatureDao;

        @Autowired
        private ContributeurContributeurService contributeurService ;
        @Autowired
        private ContractContributeurService contractService ;
