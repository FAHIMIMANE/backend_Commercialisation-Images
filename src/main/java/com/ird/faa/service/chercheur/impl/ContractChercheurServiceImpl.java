...
import com.ird.faa.service.chercheur.facade.ContractChercheurService;
        import com.ird.faa.service.chercheur.facade.TypeContratChercheurService;
...
@Service
public class ContractChercheurServiceImpl extends AbstractServiceImpl<Contract> implements ContractChercheurService {
...
private ContractDao contractDao;
    ...
    private ArchivableService<Contract> archivableService;
        @Autowired
        private TypeContratChercheurService typeContratService ;
        @Autowired
        private SignatureChercheurService signatureService ;
...
contracts.forEach(e->contractDao.save(e));
        ...
        public List<Contract> findAllNonArchive(){
        String query = "SELECT o FROM Contract o  WHERE o.archive != true AND o.visible = true";
            query+= " ORDER BY o.dateDebut";
        return entityManager.createQuery(query).getResultList();
        }

        public List<Contract> findAllByOwner(){
        List<Contract> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM Contract o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
            query+= " ORDER BY o.dateDebut";
