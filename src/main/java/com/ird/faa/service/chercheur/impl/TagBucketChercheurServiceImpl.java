...
import com.ird.faa.service.chercheur.facade.TagBucketChercheurService;
...
@Service
public class TagBucketChercheurServiceImpl extends AbstractServiceImpl<TagBucket> implements TagBucketChercheurService {

@Autowired
private TagBucketDao tagBucketDao;

        @Autowired
        private BucketChercheurService bucketService ;
        @Autowired
