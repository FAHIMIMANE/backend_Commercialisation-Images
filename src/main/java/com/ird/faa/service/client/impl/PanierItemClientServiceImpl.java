...
@Service
public class PanierItemClientServiceImpl extends AbstractServiceImpl<PanierItem> implements PanierItemClientService {

@Autowired
private PanierItemDao panierItemDao;

        @Autowired
        private PanierClientService panierService ;
        @Autowired
