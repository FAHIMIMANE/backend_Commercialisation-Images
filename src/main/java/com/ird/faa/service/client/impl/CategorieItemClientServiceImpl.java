...
@Service
public class CategorieItemClientServiceImpl extends AbstractServiceImpl<CategorieItem> implements CategorieItemClientService {

@Autowired
private CategorieItemDao categorieItemDao;

        @Autowired
        private CategorieImageClientService categorieImageService ;
        @Autowired
