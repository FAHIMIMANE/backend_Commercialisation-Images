...
import com.ird.faa.service.client.facade.BucketClientService;
        ...
        import com.ird.faa.service.client.facade.ContributeurClientService;
...
@Service
public class BucketClientServiceImpl extends AbstractServiceImpl<Bucket> implements BucketClientService {

@Autowired
private BucketDao bucketDao;

        @Autowired
        private StateBucketClientService stateBucketService ;
        @Autowired
        private ContributeurClientService contributeurService ;
        @Autowired
