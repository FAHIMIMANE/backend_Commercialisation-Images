...
import com.ird.faa.service.client.facade.BucketClientService;
...
import com.ird.faa.service.client.facade.TypeImageClientService;
...
@Service
public class ImageClientServiceImpl extends AbstractServiceImpl<Image> implements ImageClientService {

    @Autowired
    private ImageDao imageDao;

    @Autowired
    private BucketClientService bucketService;
    @Autowired
    private CategorieItemClientService categorieItemService;
    @Autowired
    private ClientClientService clientService;
    @Autowired
    private TypeImageClientService typeImageService;
