...
@Service
public class PanierItemAdminServiceImpl extends AbstractServiceImpl<PanierItem> implements PanierItemAdminService {

@Autowired
private PanierItemDao panierItemDao;

        @Autowired
        private PanierAdminService panierService ;
        @Autowired
