...
import com.ird.faa.service.chercheur.facade.EtatImageChercheurService;
...
@RestController
@RequestMapping("api/chercheur/etatImage")
public class EtatImageRestChercheur {

@Autowired
private EtatImageChercheurService etatImageService;
