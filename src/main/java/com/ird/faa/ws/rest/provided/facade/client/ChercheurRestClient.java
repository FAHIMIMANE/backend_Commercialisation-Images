...
import com.ird.faa.service.client.facade.ChercheurClientService;
...
@RestController
@RequestMapping("api/client/chercheur")
public class ChercheurRestClient {

@Autowired
private ChercheurClientService chercheurService;
