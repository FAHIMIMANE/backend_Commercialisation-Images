...
import com.ird.faa.service.client.facade.TypeClientClientService;
...
@RestController
@RequestMapping("api/client/typeClient")
public class TypeClientRestClient {

@Autowired
private TypeClientClientService typeClientService;
