...
import com.ird.faa.ws.rest.provided.converter.*;
...
public class CategorieItemRestClient {
    ...
    public List<CategorieItemVo> findAll() {
        imageConverter.setCategorieItems(false);
        clientConverter.setImages(false);
        bucketConverter.setImages(false);
        contributeurConverter.setBuckets(false);
        imageConverter.setClient(false);
        List<CategorieItemVo> categorieItemVos = categorieItemConverter.toVo(categorieItemService.findAll());
        imageConverter.setCategorieItems(true);
        clientConverter.setImages(true);
        bucketConverter.setImages(true);
        contributeurConverter.setBuckets(true);
        imageConverter.setClient(true);


        return categorieItemVos;
    }
