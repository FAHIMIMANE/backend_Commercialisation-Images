...
import com.ird.faa.service.client.facade.TypePaiementClientService;
...
@RestController
@RequestMapping("api/client/typePaiement")
public class TypePaiementRestClient {

@Autowired
private TypePaiementClientService typePaiementService;
